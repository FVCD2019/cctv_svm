...
class DISTORT:
    ...
    def undistortion(self, cam_id0=0):
        ...
        #resource2 = "/dev/video" + str(cam_id2)
        cap0 = cv2.VideoCapture(resource0)
        #cap1 = cv2.VideoCapture(resource1)
        #cap2 = cv2.VideoCapture(resource2)

        if (cap0.isOpened()):
        #if (cap0.isOpened() and cap1.isOpened() and cap2.isOpened()):
    ...
    def run(self):
        ...
        #self.undistortion(cam_id0=0,cam_id1=1,cam_id2=2)
